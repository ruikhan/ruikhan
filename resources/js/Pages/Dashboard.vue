...
/* ==================== TOAST NOTIFICATION ==================== */
.toast-notification {
    @apply fixed top-20 right-4 z-[60] w-[90vw] sm:w-96 rounded-2xl shadow-2xl overflow-hidden;
...
.time-widget-gradient {
    @apply absolute inset-0 animate-gradient-rotate;
...
.search-input {
    @apply w-full px-5 py-4 pl-14 bg-transparent text-white placeholder-gray-500 text-[15px];
...
.app-item {
    @apply flex flex-col items-center gap-2 rounded-3xl p-2 active:scale-90 transition-all duration-500 opacity-0;
...
.desktop-feature-card {
    @apply relative overflow-hidden flex flex-col justify-between p-5 rounded-3xl shadow-xl border border-white/10 transition-all duration-500 cursor-pointer opacity-0;
    @apply focus:outline-none focus-visible:ring-2 focus-visible:ring-white;
}
