...
const setupFastPolling = () => {
    ...
    console.log('⏱️ Starting polling (5s)');
        ...
        <Transition name="panel-slide">
            ...
            >
                ...
                <div v-else-if="loadingError" class="error-state">
                    ...
                    <p class="error-subtitle">Check console for details</p>
...
/* ==================== CONNECTION INDICATOR ==================== */
.connection-indicator {
    @apply absolute -top-1 -left-1 w-2 h-2 rounded-full;
}
...
/* ==================== BELL BUTTON ==================== */
.bell-button {
    @apply relative p-2 rounded-full transition-all duration-300 active:scale-90;
...
.bell-icon {
    @apply w-5 h-5 sm:w-6 sm:h-6 text-gray-300 transition-all duration-300;
}
...
.unread-badge {
    @apply absolute -top-1 -right-1 flex items-center justify-center min-w-[20px] h-5 px-1.5 rounded-full text-[10px] font-bold text-white shadow-lg animate-pulse;
    background: linear-gradient(135deg, rgba(239, 68, 68, 1), rgba(236, 72, 153, 1));
}

/* ==================== PANEL ==================== */
.notification-panel {
    @apply absolute right-0 top-full mt-3 w-[90vw] sm:w-96 max-h-[80vh] rounded-2xl shadow-2xl overflow-hidden z-50;
...
.loading-spinner {
    @apply w-10 h-10 rounded-full border-4 border-blue-500/20 border-t-blue-500 animate-spin mb-3;
}
...
.retry-btn {
    @apply px-4 py-2 rounded-lg text-xs font-medium transition-colors;
    background: rgba(59, 130, 246, 0.2);
    @apply text-blue-300;
}
...
.empty-icon {
    @apply w-16 h-16 rounded-full flex items-center justify-center text-3xl mb-3;
    background: rgba(31, 41, 55, 0.5);
}
...
.notification-item {
    @apply w-full text-left px-4 py-3 transition-colors border-b border-white/5 flex gap-3;
    @apply focus:outline-none focus-visible:bg-white/5;
}
...
.notification-icon {
    @apply w-10 h-10 rounded-xl flex items-center justify-center text-xl border border-white/10;
...
.notification-unread-dot {
    @apply flex-shrink-0 w-2 h-2 bg-blue-500 rounded-full;
}
...
.view-all-btn {
    @apply w-full text-center text-sm font-medium transition-colors;
    @apply text-blue-400 hover:text-blue-300;
}
...
.toast-close {
    @apply flex-shrink-0 p-1 rounded-lg transition-colors active:scale-90;
}
